...
(function ($) {
    ...
    $.Autocompleter = function (input, options) {
        ...
        $input.click(function () {
            ...
            $('.default').remove();
            if (options.autotype == "clients") {
                $('#result_list').append('<div class="default">' + options.intro_text + '</div>'); $('#result_list').css('display', '');
            }
            else if (options.autotype == "jobs") {
                $('#result_list2').append('<div class="default">' + options.intro_text + '</div>'); $('#result_list2').css('display', '');
            }
        ...
        $('body').click(function () {
            ...
            if (options.autotype == "clients") {
                ...
                $('#result_list2 ul').remove();
            }
        });
        $('.facelist').click(function () { $('#' + this.id).focus(); });
        var timeout;
        var previousValue = "";
                ...
                case KEY.DEL:
                    ...
                    if ($input.val() == "" && $('#bit-' + data_tag) && $('#bit-' + data_tag).attr('class') == "token token_selected") {
                        ...
                        if (options.autotype == "clients") {
                            ...
                            $('#result_list2 ul').remove();
                            $('#result_list2 div').remove();
                            $('#result_list2').append('<div class="default">' + options.intro_text + '</div>');
                        }
                    }
                    else {
                        onChange(1, true);
        ...
        function MakeBox(data) {
            ...
            $('#' + $input.attr("id")).parent().before(elemLI);
            $input.val('');
            $input.focus();
            $($input.attr("id")).focus();
            $('#' + options.saveid).val($('#' + options.saveid).val() + data[1] + ",");
        }
        function selectCurrent() {
            ...
            if (options.autotype == "clients") {
                ...
                if ($('#result_list2 ul').get() != "" && $('#result_list2 ul#no_result').get() == "") {
                    RemoveData(selected.data);
                    MakeBox(selected.data);
                    return true;
                }
        ...
        function noData() {
            ...
            if (options.autotype == "clients") {
                ...
                $('#result_list2 ul').remove()
                $('#result_list2').append('<ul id="no_result"><li>' + options.no_result + '</li></ul>')
            }
        ...
        function request(term, success, failure) {
            ...
            if (options.autotype == "clients") {
                ...
                $('#result_list2').html('<div class="default">Searching...</div>');
            }
				...
				function (data) {
				    ...
				    if (data.length == 0) {
				        ...
				        if (options.autotype == "clients") {
				            ...
				            $('#result_list2').html('<div class="default">No Results Found</div>');
				        }
