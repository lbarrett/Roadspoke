...
(function ($) {
    ...
    $.Autocompleter = function (input, options) {
        ...
        $input.click(function () { $('.default').remove(); $('#result_list2').append('<div class="default">' + options.intro_text + '</div>'); $('#result_list2').css('display', ''); })
        $('body').click(function () { $('#result_list2 ul').remove(); });
        $('.facelist2').click(function () { $input.focus(); });
        var timeout;
        var previousValue = "";
