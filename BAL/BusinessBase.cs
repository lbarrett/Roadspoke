...
namespace BAL
{
 public abstract   class BusinessBase:IDisposable
    {
        protected RoadSpokenDBDataContext DB { get; set; }
        ...
        protected BusinessBase()
        {
            ...
            DB = new RoadSpokenDBDataContext(System.Configuration.ConfigurationManager.ConnectionStrings["RoadSpokenConn"].ConnectionString);
